...
namespace Headlines.BL.Facades
{
    public interface IArticleFacade
    {
        ...
        Task<long> GetArticlesCountByFiltersSkipTakeAsync(int skip, int take, string currentTitlePrompt, long[]? articleSources = null, CancellationToken cancellationToken = default);
    }
}