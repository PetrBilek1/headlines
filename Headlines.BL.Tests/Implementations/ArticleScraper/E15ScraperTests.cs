...
{
    public sealed class E15ScraperTests : ScraperTestBase<E15Scraper>
    {
        [Theory]
        [InlineData("001")]
        [InlineData("002")]
        ...
        {
            //Arrange
            var html = await ScraperDataLoader.GetHtmlAsync("E15", index);
            var expected = await ScraperDataLoader.GetExpectedAsync("E15", index);
